...
<div class="right_col" role="main">
	...
	<div class="x_content">
		<form class="form-horizontal form-label-left input_mask" method="post" action="insert_district.php" enctype="multipart/form-data">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
					<label  class="col-md-2" for="heard">District Name</label>
					<div class="col-md-10">
						
						<input type="text" class="form-control" id="heard" placeholder="Enter Country name" required="" name="district">
					</div>
				</div>
			</div>
			<div class="row">
